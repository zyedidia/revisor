...
func (m *Machine) GetSupportedCPUID(kvmCPUID *CPUID) error {
	var c *CPUID
...
// as needed.
func (vcpu *vcpu) SetCPUID2(kvmCPUID *CPUID) error {
	data, err := kvmCPUID.Bytes()
	if err != nil {
		return err
	}

	if _, err := Ioctl(vcpu.fd,
...
func (vcpu *vcpu) GetCPUID2(kvmCPUID *CPUID) error {
	var c *CPUID
...
func (m *Machine) GetEmulatedCPUID(kvmCPUID *CPUID) error {
	var c *CPUID
